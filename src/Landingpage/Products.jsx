    ...
    <div className="max-w-285 mx-auto px-4">
      <div className="w-full flex flex-col md:flex-row justify-between md:items-center mt-16 md:mt-32 gap-6">
        ...
        <div className="flex items-center gap-3">
          <button
            className="w-10 h-10 sm:w-12.5 sm:h-12.5 text-xl sm:text-2xl rounded-full bg-white border border-[#414143] hover:bg-[#01C6B5] hover:text-white hover:border-none transition">
            &lt;
          </button>
          <button
            className="w-10 h-10 sm:w-12.5 sm:h-12.5 text-xl sm:text-2xl rounded-full bg-white border border-[#414143] hover:bg-[#01C6B5] hover:text-white hover:border-none transition">
