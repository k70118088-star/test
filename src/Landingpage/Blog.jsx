...
import BlogCard from "../Comman/BlogCard";
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-0">
      <div className="max-w-285 mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-16 sm:mt-24 lg:mt-32.5 gap-6">
