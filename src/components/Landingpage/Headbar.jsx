...
const Headbar = () => {
  return (
    <div className="bg-[#F4F4F4] max-w-360 m-auto py-2">
      <nav className="max-w-285 mx-auto sm:px-4 px-2 flex flex-col sm:flex-row justify-between items-center gap-2">
